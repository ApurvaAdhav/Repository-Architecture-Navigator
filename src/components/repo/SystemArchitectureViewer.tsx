...
// --------------------------------------------------------
const getLayoutedElements = (nodes: Node[], edges: Edge[], isFlow: boolean, direction = "TB") => {
...
const SystemArchitectureCanvas = ({ onNodeSelect }: SystemArchitectureViewerProps) => {
  ...
  useEffect(() => {
    ...
    // ── ROLE-BASED VIEW ──────────────────────────────────
      ...
      const folderMap = new Map<string, FolderNodeData>();
      ...
      const fEdgeMap = new Map<string, Edge>();
      let ec = 0;
